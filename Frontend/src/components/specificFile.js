...
class SpecificFile extends Component {
  ...
  //   let specificFileEditor = this.state.specificFileEditor;
  //   if(prevState.specificFileEditor!=specificFileEditor){
  //     console.log(this.state.specificFileEditor)
  //   }
  // }
  componentDidMount = async ()=> {
    ...
    try{
      ...
      let filecontent = Buffer.from(data.buffer.data).toString()
