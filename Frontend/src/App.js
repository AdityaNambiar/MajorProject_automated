...
import builddeploy from "./components/deployment/DeployStatus"
import directdeploy from "./components/deployment/DeployDirect"
      ...
      <div>
        <div className="content">
          <Switch>
            ...
            <Route path="/buildanddeploy" component={builddeploy}/>
            <Route path="/directdeploy" component={directdeploy}/>
